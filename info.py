...
# Bot information
SESSION = environ.get('SESSION', 'ZinFlix_Filter_Bot')
...
# Bot Admins
ADMINS = environ.get('ADMINS', '6087923109')
if len(ADMINS) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1001810601768')
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://toha69:2yNS8yTvs6gWNb8l@cluster0.u9cefbf.mongodb.net/?retryWrites=true&w=majority")
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/SL_Support')
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/SL_Updates')
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001826781136")
if len(BIN_CHANNEL) == 0:
    logging.error('BIN_CHANNEL is missing, exiting now')
    exit()
else:
    BIN_CHANNEL = int(BIN_CHANNEL)
URL = environ.get("URL", "149.102.231.114")
if len(URL) == 0:
